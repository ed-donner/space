...
For Graphics, have a modernized version of Elite: use filled in 3d shapes with modern 3d graphics, not the original wire-frame style from the 80s. Full color, photorealistic graphics where possible.
...
Use Playwright, and have it so that you can automatically play through games, screenshot, investigate.
